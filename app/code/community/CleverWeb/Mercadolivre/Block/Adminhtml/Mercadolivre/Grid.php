  ...
  protected function _prepareCollection(){
	  ...
	  */
	  ...
	  $collection->joinTable(
            ...
            array('ml_id','published','type'),null,'inner'
      );
	 
	  //$collection->getSelect()->join('ml_product', 'product_id=entity_id', array('ml_id'));
      ...
      $this->addColumn('entity_id',
		...
		$this->addColumn('ml_type',
            array(
                ...
                'index' => 'type',
                'type'  => 'options',
                'options' => CleverWeb_Mercadolivre_Model_System_Config_Source_Type::optSelectArray(),
        ));
