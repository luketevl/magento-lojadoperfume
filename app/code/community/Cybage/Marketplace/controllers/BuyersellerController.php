...
class Cybage_Marketplace_BuyersellerController extends Mage_Core_Controller_Front_Action
{
    ...
    public function saveAction() {
        try {
            ...
            Mage::getSingleton('core/session')->addSuccess($this->__('A pergunta foi enviada com sucesso!!'));
        } catch (Exception $e) {
            Mage::getSingleton('core/session')->addError($this->__('A pergunta não foi enviada, tente depois de algum tempo.'.$e));
        }
