...
class Cybage_Marketplace_Block_Adminhtml_Seller_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
		...
		$fieldset->addField('seller_subscriber', 'select', array(
            'label'     => Mage::helper('marketplace')->__('Vendedor'),
            'name'      => 'seller_subscriber',
            'values'    => $statusv
        ));
		
		$fieldset->addField('company_description', 'textarea', array(
            'label'     => Mage::helper('marketplace')->__('Descrição da Empresa'),
