...
class Cybage_Marketplace_Model_Resource_Customer extends Mage_Customer_Model_Resource_Customer
{
    ...
    protected function _beforeSave(Varien_Object $customer)
    {
        ...
        if (!$customer->getEmail()) {
            throw Mage::exception('Mage_Customer', Mage::helper('customer')->__('E-mail do cliente é necessário'));
        }
        ...
        if ($result) {
            throw Mage::exception(
                'Mage_Customer', Mage::helper('customer')->__('Esse email de cliente já existe'),
        ...
        if ($compresult) {
            throw Mage::exception('Mage_Customer', Mage::helper('customer')->__('O nome da empresa já existe'));
        }
       /*Check if same company name already exist*/
